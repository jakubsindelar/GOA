...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { date: @homework.date, name: @homework.name, note: @homework.note, subject_id: @homework.subject_id }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { date: @homework.date, name: @homework.name, note: @homework.note, subject_id: @homework.subject_id }
    assert_redirected_to homework_path(assigns(:homework))
  end
